...
import VotesTracker from '../components/votesTracker'
...
export default function UserExercises(props){
    ...
    return (
        <div className='inline-block p-2 m-4 cursor-pointer  transition duration-0 hover:scale-110'>
            <div key={_id} >
                <h1>{name}</h1>
                ...
                <div>
                    <button className="bg-black text-white w-40 rounded"
